...
import {ConfigPlugin, withAndroidManifest, withDangerousMod, withInfoPlist, withPodfileProperties, withProjectBuildGradle} from '@expo/config-plugins'
import fs from 'fs'
  ...
  if (props.android || Object.keys(props).some(key => commonConfigKeys.includes(key as keyof PressReaderCommonConfig))) {
    config = withDangerousMod(config, [
      ...
      async config => {
        ...
        if (props.brandGradientStartColor !== undefined) resources.push({
          type: 'color',
        ...
        if (props.sdkExitButtonText !== undefined) resources.push({
          type: 'string',
          name: 'sdk_exit_button_text',
          value: props.sdkExitButtonText,
          translatable: false
        })
        if (props.supportEmailAddress !== undefined) resources.push({
          type: 'string',
        ...
        if (props.isPopupArticleViewAllowed !== undefined) resources.push({
          type: 'bool',
          name: 'is_popup_article_view_allowed',
          value: String(props.isPopupArticleViewAllowed)
        })
        if (props.readerExternalLinksEnabled !== undefined) resources.push({
          type: 'bool',
        ...
        if (props.showCustomerSupport !== undefined) resources.push({
          type: 'bool',
          name: 'pref_feedback_show_support',
          value: String(props.showCustomerSupport)
        })
        if (props.supportPhoneNumber !== undefined) resources.push({
          type: 'string',
        ...
        if (props.privacyPolicyUrl !== undefined) resources.push({
          type: 'string',
